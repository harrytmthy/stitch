...
class StitchCodeGenerator(
    ...
    fun generateDependencyTable(nodes: List<DependencyNode>, fieldInjectors: List<FieldInjectorInfo>) {
        logger.info("Stitch: Generating DependencyTable with ${nodes.size} bindings and ${fieldInjectors.size} field injection targets")
        ...
        generateTableAdapterFile(nodes, fieldInjectors, dependencies)
    ...
    private fun generateTableAdapterFile(
        ...
        val file = FileSpec.builder(GENERATED_PACKAGE, GENERATED_CLASS_NAME)
            .addFileComment("Generated by Stitch KSP Compiler - DO NOT EDIT")
            .addType(generateTableAdapter(nodes, fieldInjectors))
            .build()
     ...
     */
    private fun generateTableAdapter(nodes: List<DependencyNode>, fieldInjectors: List<FieldInjectorInfo>): TypeSpec {
        ...
        return TypeSpec.objectBuilder(GENERATED_CLASS_NAME)
            ...
            .addFunction(generateInjectFieldsMethod(fieldInjectors))
            .build()
    }
     ...
     */
    private fun generateInjectFieldsMethod(fieldInjectors: List<FieldInjectorInfo>): FunSpec {
        val typeVar = TypeVariableName("T", Any::class)
        ...
        return FunSpec.builder("injectFields")
            ...
            .addCode(
                buildCodeBlock {
                    if (fieldInjectors.isEmpty() || fieldInjectors.none { it.injectableFields.isNotEmpty() }) {
                        // No field injection targets - no-op
                    ...
                    fieldInjectors.forEach { fieldInjector ->
                        if (fieldInjector.injectableFields.isEmpty()) {
                            return@forEach
                        }
                        val className = fieldInjector.classDeclaration.toClassName()
                        val methodName = "inject${className.simpleName}"
